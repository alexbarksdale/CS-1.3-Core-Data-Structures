...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        Best and worst case running time: O(n) because we have to loop through all the nodes to find the tallest one"""
        if self.is_leaf():
            return 0
        else:
            left_height = 0
...
class BinarySearchTree(object):
    ...
    def contains(self, item):
        ...
        Best case running time: O(1) if the item we're looking for is at the root
        Worst case running time: O(h) h being the height of the tree since we have to loop through to the deepest node"""
    ...
    def insert(self, item):
        ...
        Best case running time: O(1) if we're inserting at the root 
        Worst case running time: O(h) h being the height of the tree since we have to loop through to the deepest node"""
    ...
    def _traverse_in_order_recursive(self, node, visit):
        ...
        KEY: LEFT, ROOT, RIGHT
        Time and space: O(n * vist) because you need to visit every item"""
